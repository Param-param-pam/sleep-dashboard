...
data = [
    ...
    ['21.07.2026','Юля',7,7],
    ['21.07.2026','Даша',6,6],
    ['22.07.2026','Юля',2.5,3],
    ['22.07.2026','Даша',5,5],
    ['23.07.2026','Юля',4,4],
    ['23.07.2026','Даша',5,5],
    ['24.07.2026','Юля',6.5,7],
    ...
    ['01.08.2026','Юля',6,6],
    ['01.08.2026','Даша',9,9],
    ['02.08.2026','Юля',6.5,6.5],
    ['02.08.2026','Даша',8,8],
    ['03.08.2026','Юля',8,8],
    ['03.08.2026','Даша',7,7.5],
    ['04.08.2026','Юля',6.5,7],
    ['04.08.2026','Даша',7,7.5],
    ['05.08.2026','Юля',2.5,3],
    ['05.08.2026','Даша',2.5,3],
    ['06.08.2026','Юля',5,5],
    ['06.08.2026','Даша',5,5],
    ['07.08.2026','Юля',5,5],
    ['07.08.2026','Даша',5,5],
    ['08.08.2026','Юля',6,6],
    ['08.08.2026','Даша',7,7],
    ['09.08.2026','Юля',9,9.5],
    ['09.08.2026','Даша',9,9.5],
    ['10.08.2026','Юля',4,4.5],
    ['10.08.2026','Даша',6,6.5],
    ['11.08.2026','Юля',7,7],
    ['11.08.2026','Даша',7,7],
    ['12.08.2026','Юля',5,5],
    ['12.08.2026','Даша',5,5.5],
    ['13.08.2026','Юля',5,5],
    ['13.08.2026','Даша',5,5],
    ['14.08.2026','Юля',4,4],
    ['14.08.2026','Даша',4,4],
    ['15.08.2026','Юля',8,8],
    ['15.08.2026','Даша',9,9],
    ['16.08.2026','Юля',6.5,6.5],
    ['16.08.2026','Даша',6.5,6.5],
    ['17.08.2026','Юля',5,5],
    ['17.08.2026','Даша',5,5],
    ['18.08.2026','Юля',7,7],
    ['18.08.2026','Даша',7,7],
    ['19.08.2026','Юля',4.5,4.5],
    ['19.08.2026','Даша',6,6],
    ['20.08.2026','Юля',6.5,6.5],
    ['20.08.2026','Даша',6.5,6.5],
    ['21.08.2026','Юля',4.5,5],
    ['21.08.2026','Даша',5,5],
    ['22.08.2026','Юля',7,7],
    ['22.08.2026','Даша',8,8],
    ['23.08.2026','Юля',0,0],
